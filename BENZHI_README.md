...
- 项目：zhanglei10281852-gif/pet-foster-task-11
...
./build_benzhi_docker.sh benzhi-task-163-amd64 linux/amd64
./build_benzhi_docker.sh benzhi-task-163-arm64 linux/arm64
docker run -it benzhi-task-163-amd64:latest
docker run -it --platform linux/arm64 benzhi-task-163-arm64:latest
```

## 题目验证命令

1. 预期退出码 0：`go test ./internal/pet -run ^TestAnnotationMissingPetOwnerConflict$ -count=1`
